...
from application.catalog import main
from application import db
from application.catalog.models import Book, Publication
from application.catalog.forms import EditBookForm, CreateBookForm
...
def delete_book(book_id):
    ...
    return render_template('delete-book.html', book=book, book_id=book.id)
